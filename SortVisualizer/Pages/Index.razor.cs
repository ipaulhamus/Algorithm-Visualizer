...
namespace SortVisualizer.Pages
{
	...
	public partial class Index : ComponentBase
	{
        ...
        public AlgorithmDetails[] SortingAlgorithmInstances = [
            ...
            new AlgorithmDetails(Algorithm.PancakeSort, Complexity.O_N2, Complexity.O_N2, Complexity.O_N2, new PancakeSort()),
		...
		private void ChangeAlgorithmToRun(ChangeEventArgs e)
		{
			switch (e.Value!.ToString()!)
			{
                ...
                case "merge":
                    ...
                    INSTRUCTIONS_UNTIL_REPAINT = 5;
                    break;
                // TODO: Add your additional sorting algorithms here
                case "pancake":
                    AlgorithmToUse = Algorithm.PancakeSort;
                    INSTRUCTIONS_UNTIL_REPAINT = 30;
                    break;
                case "oddeven":
                    AlgorithmToUse = Algorithm.OddEvenSort;
                    INSTRUCTIONS_UNTIL_REPAINT = 35;
                    break;
                case "gnome":
